...
public class CommandGM {
	...
	public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
	   ...
	   private static void method_13390(ServerCommandSource serverCommandSource_1, ServerPlayerEntity serverPlayerEntity_1, GameMode gameMode_1) {
		      TranslatableComponent textComponent_1 = new TranslatableComponent("gameMode." + gameMode_1.getName(), new Object[0]);
		      if (serverCommandSource_1.getEntity() == serverPlayerEntity_1) {
		         serverCommandSource_1.sendFeedback(new TranslatableComponent("commands.gamemode.success.self", new Object[]{textComponent_1}), true);
		      } else {
		         if (serverCommandSource_1.getWorld().getGameRules().getBoolean("sendCommandFeedback")) {
		            serverPlayerEntity_1.sendMessage(new TranslatableComponent("gameMode.changed", new Object[]{textComponent_1}));
		         }

		         serverCommandSource_1.sendFeedback(new TranslatableComponent("commands.gamemode.success.other", new Object[]{serverPlayerEntity_1.getDisplayName(), textComponent_1}), true);
		      }
